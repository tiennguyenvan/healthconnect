...
public class PatientListForAppointmentActivity extends AppCompatActivity {
    private $ inThis;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        patientListRvAdapter = new PatientListRvAdapter(patientList, patient -> {
            inThis.passToScreen(AppointmentNewActivity.class, R.string.key_patient_id, patient.getId());
        });
